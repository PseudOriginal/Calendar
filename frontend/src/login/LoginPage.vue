    ...
    <div class="col-sm-6 offset-sm-3">
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <img v-show="status.loggingIn" alt="login-loading" src="data:image/gif;base64," />
